...
// Vibração removida temporariamente devido a problemas de compatibilidade
...
class SensorService {
  ...
  Future<void> _vibrateDevice() async {
    // Vibração desabilitada temporariamente
    // A funcionalidade de detecção de shake continua funcionando normalmente
    print('📳 Shake detectado (vibração desabilitada)');
  }
